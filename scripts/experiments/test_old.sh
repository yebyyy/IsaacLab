...
CMD="scripts/reinforcement_learning/rsl_rl/train.py --task Isaac-Cartpole-v0 --headless --video --video_length 1000 --num_envs 2 --max_iterations 100 --video --video_length 1000"
